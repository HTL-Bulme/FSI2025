 ...
 * @author gl
 */
public class PickingorderGui extends javax.swing.JFrame {

    private PickingOrderRepository pickingOrderRepo = new PickingOrderRepository();
    private OutboundOrderRepository outboundOrderRepo = new OutboundOrderRepository(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PickingorderGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PickingorderGui().setVisible(true);
            }
        });
    }
